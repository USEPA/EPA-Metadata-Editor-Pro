    ...
    internal class Utils
    {
        ...
        public static string GetResString(string key)
        {
            if (null == _resourceManager)
                _resourceManager = new ResourceManager("EMEProToolkit.Properties.Resources", System.Reflection.Assembly.GetExecutingAssembly());
        ...
        static public String ExtractResponsiblePartyLabel(XmlNode root, string format)
        {
            ...
            var roleLabel = EMEProToolkit.Properties.Resources.LBL_CI_PARTY_ROLE_UNKNOWN;
