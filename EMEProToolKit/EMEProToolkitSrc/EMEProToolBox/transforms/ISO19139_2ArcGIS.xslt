...
<xsl:stylesheet version="1.0" 
  ...
  <xsl:template match="/gmi:MI_Metadata | /gmd:MD_Metadata">
    <metadata>
      ...
      <xsl:if test="(local-name(.) = 'MD_Metadata') or (local-name(.) = 'MI_Metadata')">
