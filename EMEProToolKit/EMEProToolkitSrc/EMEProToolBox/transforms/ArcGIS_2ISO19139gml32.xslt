...
<xsl:stylesheet version="1.0" exclude-result-prefixes="msxsl" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.isotc211.org/2005/gmd" xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gts="http://www.isotc211.org/2005/gts" xmlns:srv="http://www.isotc211.org/2005/srv" xmlns:gml="http://www.opengis.net/gml/3.2" xmlns:gmx="http://www.isotc211.org/2005/gmx" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
  ...
  <xsl:template name="metadata">
    <xsl:choose>
      ...
      <xsl:when test="(/metadata/Esri/ArcGISProfile = 'NAP') and (not(/metadata/mdFileID) or (/metadata/mdFileID = '')) and (not(/metadata/Esri/PublishedDocID) or (/metadata/Esri/PublishedDocID != ''))">
        <fileIdentifier gco:nilReason="missing"/>
      </xsl:when>
    </xsl:choose>
      ...
      <xsl:when test="(count(/metadata/mdDateSt[. != '']) &gt; 0)">
        <xsl:for-each select="(/metadata/mdDateSt[. != ''])[1]">
          <xsl:call-template name="dateOrDateTimeElements">
            <xsl:with-param name="eleName">dateStamp</xsl:with-param>
          </xsl:call-template>
        </xsl:for-each>
      </xsl:when>
      <xsl:otherwise>
    ...
    <xsl:if test="(/metadata/Esri/ArcGISProfile = 'NAP') and (not(/metadata/refSysInfo/RefSystem/refSysID) or (/metadata/refSysInfo/RefSystem/refSysID = '')) and ((/metadata/dataIdInfo[1]/spatRpType/SpatRepTypCd/@value = '001') or (/metadata/dataIdInfo[1]/spatRpType/SpatRepTypCd/@value = '002') or (/metadata/dataIdInfo[1]/spatRpType/SpatRepTypCd/@value = '004'))">
      <referenceSystemInfo gco:nilReason="missing"/>
    </xsl:if>
    <xsl:if test="not(/metadata/Esri/ArcGISProfile = 'NAP')">
    ...
    <xsl:choose>
      ...
      <xsl:otherwise>
        <identificationInfo gco:nilReason="missing"/>
      </xsl:otherwise>
    </xsl:choose>
  ...
  <xsl:template name="PT_Locale">
    <xsl:choose>
      ...
      <xsl:otherwise>
        <languageCode gco:nilReason="missing"/>
      </xsl:otherwise>
    </xsl:choose>
  ...
  <xsl:template name="MD_MaintenanceInformation">
    <xsl:choose>
      ...
      <xsl:otherwise>
        <maintenanceAndUpdateFrequency gco:nilReason="missing"/>
      </xsl:otherwise>
    </xsl:choose>
    <xsl:for-each select="(dateNext[. != ''])[1]">
      <xsl:call-template name="dateOrDateTimeElements">
        <xsl:with-param name="eleName">dateOfNextUpdate</xsl:with-param>
      </xsl:call-template>
    </xsl:for-each>
  ...
  <xsl:template name="MD_Dimension">
    <xsl:choose>
      ...
      <xsl:otherwise>
        <dimensionName gco:nilReason="missing"/>
      </xsl:otherwise>
    </xsl:choose>
    <xsl:choose>
  ...
  <xsl:template name="MD_Georectified">
    ...
    <xsl:choose>
      ...
      <xsl:otherwise>
        <checkPointAvailability gco:nilReason="missing"/>
      </xsl:otherwise>
    </xsl:choose>
    ...
    <xsl:choose>
      ...
      <xsl:otherwise>
        <pointInPixel gco:nilReason="missing"/>
      </xsl:otherwise>
    </xsl:choose>
  ...
  <xsl:template name="MD_Georeferenceable">
    ...
    <xsl:choose>
      ...
      <xsl:otherwise>
        <controlPointAvailability gco:nilReason="missing"/>
      </xsl:otherwise>
    </xsl:choose>
    <xsl:choose>
      ...
      <xsl:otherwise>
        <orientationParameterAvailability gco:nilReason="missing"/>
      </xsl:otherwise>
    </xsl:choose>
    ...
    <xsl:choose>
      ...
      <xsl:otherwise>
        <georeferencedParameters gco:nilReason="missing"/>
      </xsl:otherwise>
    </xsl:choose>
  ...
  <xsl:template name="MD_ExtendedElementInformation">
    ...
    <xsl:choose>
      ...
      <xsl:otherwise>
        <definition gco:nilReason="missing"/>
      </xsl:otherwise>
    </xsl:choose>
    ...
    <xsl:choose>
      ...
      <xsl:otherwise>
        <dataType gco:nilReason="missing"/>
      </xsl:otherwise>
    </xsl:choose>
    ...
    <xsl:choose>
      ...
      <xsl:otherwise>
        <parentEntity gco:nilReason="missing"/>
      </xsl:otherwise>
    </xsl:choose>
    <xsl:choose>
  ...
  <xsl:template name="identificationInfo">
    <xsl:choose>
      ...
      <xsl:otherwise>
        <citation gco:nilReason="missing"/>
      </xsl:otherwise>
    </xsl:choose>
    <xsl:choose>
  ...
  <xsl:template name="SV_OperationMetadata">
    ...
    <xsl:choose>
      ...
      <xsl:otherwise>
        <srv:DCPList gco:nilReason="missing"/>
      </xsl:otherwise>
    </xsl:choose>
  ...
  <xsl:template name="MD_Usage">
    <xsl:choose>
      ...
      <xsl:otherwise>
        <specificUsage gco:nilReason="missing"/>
      </xsl:otherwise>
    </xsl:choose>
    <xsl:for-each select="(usageDate[. != ''])[1]">
      <xsl:call-template name="dateTimeElements">
        <xsl:with-param name="eleName">usageDateTime</xsl:with-param>
      </xsl:call-template>
    </xsl:for-each>
    ...
    <xsl:choose>
      ...
      <xsl:otherwise>
        <userContactInfo gco:nilReason="missing"/>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>
  <xsl:template name="MD_AggregateInformation">
    ...
    <xsl:choose>
      ...
      <xsl:otherwise>
        <associationType gco:nilReason="missing"/>
      </xsl:otherwise>
    </xsl:choose>
  ...
  <xsl:template name="MD_CoverageDescription">
    ...
    <xsl:choose>
      ...
      <xsl:otherwise>
        <contentType gco:nilReason="missing"/>
      </xsl:otherwise>
    </xsl:choose>
  ...
  <xsl:template name="MD_RangeDimension">
    ...
    <xsl:if test="(/metadata/Esri/ArcGISProfile = 'NAP') and (not(seqID) or (seqID = '')) and (not(dimDescrp) or (dimDescrp = ''))">
      <descriptor gco:nilReason="missing"/>
    </xsl:if>
  </xsl:template>
  ...
  <xsl:template name="MD_FeatureCatalogueDescription">
    ...
    <xsl:choose>
      ...
      <xsl:otherwise>
        <includedWithDataset gco:nilReason="missing"/>
      </xsl:otherwise>
    </xsl:choose>
    ...
    <xsl:if test="(/metadata/Esri/ArcGISProfile = 'NAP') and (not(catFetTyps/genericName) or (catFetTyps/genericName = ''))">
      <featureTypes gco:nilReason="missing"/>
    </xsl:if>
    <xsl:choose>
      ...
      <xsl:otherwise>
        <featureCatalogueCitation gco:nilReason="missing"/>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>
  <xsl:template name="MD_Distribution">
    ...
    <xsl:if test="(/metadata/Esri/ArcGISProfile = 'NAP') and ((distTranOps != '') or (distributor/distorTran != '')) and (not(distFormat) or (distFormat = '')) and (not(distributor/distorCont) or not(distributor/distorFormat) or not(distributor/distorOrdPrc) or (distributor/distorCont = '') or (distributor/distorFormat = '') or (distributor/distorOrdPrc = ''))">
      <distributionFormat gco:nilReason="missing"/>
    </xsl:if>
  ...
  <xsl:template name="DQ_Element">
    ...
    <xsl:for-each select="measDateTm">
      <xsl:call-template name="dateTimeElements">
        <xsl:with-param name="eleName">dateTime</xsl:with-param>
      </xsl:call-template>
    </xsl:for-each>
    <xsl:choose>
  ...
  <xsl:template name="DQ_ConformanceResult">
    <xsl:choose>
      ...
      <xsl:otherwise>
        <specification gco:nilReason="missing"/>
      </xsl:otherwise>
    </xsl:choose>
    <xsl:choose>
  ...
  <xsl:template name="LI_Source">
    ...
    <xsl:if test="(/metadata/Esri/ArcGISProfile = 'NAP') and ((not(srcDesc) or (srcDesc = '')) and (srcExt != '') and (not(srcCitatn) or (srcCitatn = '')))">
      <sourceCitation gco:nilReason="missing"/>
    </xsl:if>
    ...
    <xsl:if test="(/metadata/Esri/ArcGISProfile = 'NAP') and ((not(srcDesc) or (srcDesc = '')) and (srcCitatn != '') and (not(srcExt) or (srcExt = '')))">
      <sourceExtent gco:nilReason="missing"/>
    </xsl:if>
    <xsl:if test="not(/metadata/Esri/ArcGISProfile = 'NAP')">
  ...
  <xsl:template name="MD_ApplicationSchemaInformation">
    ...
    <xsl:choose>
      ...
      <xsl:otherwise>
        <schemaLanguage gco:nilReason="missing"/>
      </xsl:otherwise>
    </xsl:choose>
    <xsl:choose>
  ...
  <xsl:template name="EX_GeographicBoundingBox">
    ...
    <xsl:choose>
      ...
      <xsl:otherwise>
        <westBoundLongitude gco:nilReason="missing"/>
      </xsl:otherwise>
    </xsl:choose>
    <xsl:choose>
      ...
      <xsl:otherwise>
        <eastBoundLongitude gco:nilReason="missing"/>
      </xsl:otherwise>
    </xsl:choose>
    <xsl:choose>
      ...
      <xsl:otherwise>
        <southBoundLatitude gco:nilReason="missing"/>
      </xsl:otherwise>
    </xsl:choose>
    <xsl:choose>
      ...
      <xsl:otherwise>
        <northBoundLatitude gco:nilReason="missing"/>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>
  <xsl:template name="EX_GeographicDescription">
    ...
    <xsl:choose>
      ...
      <xsl:otherwise>
        <geographicIdentifier gco:nilReason="missing"/>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>
  ...
  <xsl:template name="EX_VerticalExtent">
    <xsl:choose>
      ...
      <xsl:otherwise>
        <minimumValue gco:nilReason="missing"/>
      </xsl:otherwise>
    </xsl:choose>
    <xsl:choose>
      ...
      <xsl:otherwise>
        <maximumValue gco:nilReason="missing"/>
      </xsl:otherwise>
    </xsl:choose>
  ...
  <xsl:template name="CI_ResponsibleParty">
    ...
    <xsl:if test="(/metadata/Esri/ArcGISProfile = 'NAP') and (not(rpCntInfo) or (rpCntInfo = ''))">
      <contactInfo gco:nilReason="missing"/>
    </xsl:if>
    <xsl:choose>
  ...
  <xsl:template name="CI_OnlineResource">
    ...
    <xsl:if test="(/metadata/Esri/ArcGISProfile = 'NAP') and (not(protocol) or (protocol = ''))">
      <protocol gco:nilReason="missing"/>
    </xsl:if>
  ...
  <xsl:template name="CI_Citation">
      ...
      <xsl:when test="(count(resTitle[. != '']) &gt; 0)">
        <xsl:for-each select="(resTitle[. != ''])[1]">
          <xsl:choose>
            <xsl:when test="(/metadata/Esri/ArcGISProfile = 'INSPIRE')">
              <xsl:choose>
                <xsl:when test="(local-name(..) = 'idCitation')">
                  <xsl:choose>
                    <xsl:when test="/metadata/distInfo/distTranOps/onLineSrc/linkage[(starts-with(.,'http://') or starts-with(.,'https://') or starts-with(.,'HTTP://') or starts-with(.,'HTTPS://'))]">
                      <xsl:choose>
                        <xsl:when test="(/metadata/Esri/locales/locale/resTitle != '') and (name(../..) = 'dataIdInfo') and (count(../../preceding-sibling::dataIdInfo) = 0)">
                          <title>
                            <xsl:attribute name="xsi:type">PT_FreeText_PropertyType</xsl:attribute>
                            <gmx:Anchor>
                ...
                <xsl:otherwise>
                  <xsl:choose>
                    <xsl:when test="(../citOnlineRes/linkage[(starts-with(.,'http://') or starts-with(.,'https://') or starts-with(.,'HTTP://') or starts-with(.,'HTTPS://'))])">
                      <title>
                        <gmx:Anchor>
            ...
            <xsl:otherwise>
              <xsl:choose>
                <xsl:when test="(local-name(..) = 'idCitation') and (/metadata/Esri/locales/locale/resTitle != '') and (name(../..) = 'dataIdInfo') and (count(../../preceding-sibling::dataIdInfo) = 0)">
                  <title>
                    <xsl:attribute name="xsi:type">PT_FreeText_PropertyType</xsl:attribute>
                    <gco:CharacterString>
                      <xsl:value-of select="."/>
    ...
    <xsl:for-each select="(resEdDate[. != ''])[1]">
      <xsl:call-template name="dateOrDateTimeElements">
        <xsl:with-param name="eleName">editionDate</xsl:with-param>
      </xsl:call-template>
    </xsl:for-each>
    ...
    <xsl:if test="(/metadata/Esri/ArcGISProfile = 'NAP') and (not(citRespParty) or (citRespParty = ''))">
      <citedResponsibleParty gco:nilReason="missing"/>
    </xsl:if>
  ...
  <xsl:template name="CI_Date">
    <xsl:param name="type"/>
    <xsl:call-template name="dateOrDateTimeElements">
      <xsl:with-param name="eleName">date</xsl:with-param>
    </xsl:call-template>
    <dateType>
      <xsl:choose>
